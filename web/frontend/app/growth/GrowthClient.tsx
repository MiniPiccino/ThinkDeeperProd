          ...
          <>
            ...
            <section className="rounded-3xl border border-emerald-400/40 bg-slate-900/60 p-5 text-sm text-slate-100 shadow-2xl sm:p-6">
              ...
              <div className="mt-5 grid gap-4 sm:gap-5 lg:grid-cols-[1.1fr,1fr]">
                <div className="relative mx-auto w-full max-w-sm overflow-hidden rounded-2xl border border-white/5 bg-gradient-to-br from-black/60 to-emerald-950/60 p-4 shadow-inner sm:max-w-md sm:p-5 lg:mx-0 lg:max-w-none">
                  <div
                  ...
                  <div className="relative flex flex-col items-center gap-3 rounded-xl border border-emerald-400/30 bg-white/5 px-4 py-4 text-center backdrop-blur sm:py-5">
                    ...
                    <p className="text-lg font-semibold text-white sm:text-2xl">{levelBadge.name}</p>
                    <p className="text-xs text-emerald-100/80 sm:max-w-md sm:text-sm leading-relaxed text-center">{levelBadge.description}</p>
                    <div className="mt-1 inline-flex items-center gap-2 rounded-full border border-emerald-400/40 bg-emerald-500/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-emerald-100 sm:text-[12px]">
                ...
                <div className="mx-auto w-full max-w-sm rounded-2xl border border-white/5 bg-slate-950/60 p-4 shadow-inner sm:max-w-md sm:p-5 lg:mx-0 lg:max-w-none">
